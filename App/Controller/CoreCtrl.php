      ...
      protected function init() {
        ...
        if ($this->user()->isAdmin) {
            $menu->addChild(new Menu('user', '<i class="fa fa-user"></i> Tài khoản', url('/admin/user')))
                    ...
                    ->addChild(new Menu('cateNews', '<i class="fa fa-pie-chart"></i> Loại Tin', url('/admin/cate-news')))
                    ->addChild(new Menu('news', '<i class="fa fa-newspaper-o"></i> Tin Tức', url('/admin/news')));
//   
        }
