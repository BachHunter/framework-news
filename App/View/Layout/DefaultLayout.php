...
class DefaultLayout extends Layout {
    ...
    protected function renderLayout($content) {
        ...
        <?php endforeach; ?>
                ...
                <script src="<?php echo $this->themeUrl() ?>/js/ui-bootstrap-2.3.0.min.js"></script>

                <script src="<?php echo url('/admin/config.js') ?>"></script>


                <script src="<?php echo $this->themeUrl() ?>/js/app.js"></script>
                <script type="text/javascript" src="<?php echo $this->themeUrl() ?>/ckeditor/ckeditor.js"></script>
                <script type="text/javascript" src="<?php echo $this->themeUrl() ?>/ckeditor-master/ng-ckeditor.js"></script>
                <!--                Upload file ảnh-->
                <script type="text/javascript" src="<?php echo $this->themeUrl() ?>/js/jquery.ajax_multiple_upload.js"></script>
                <script type="text/javascript" src="<?php echo $this->themeUrl() ?>/js/jquery.ajax_upload.js"></script>
                <script type="text/javascript" src="<?php echo $this->themeUrl() ?>/js/jquery.uploadify-3.1.min.js"></script>
