RED.ngApp.directive('ngDepartmentPicker', function ($apply, $timeout) {
    ...
    return {
        'templateUrl': CONFIG.siteUrl + '/themes/nifty/components/DepartmentPicker/DepartmentPicker.php',
        'scope': {},
        'link': link
    };
});